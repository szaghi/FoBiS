...
varset                 = local                    ; named [varset:NAME] applied for this mode (see Varsets)
intrinsic_modules      = hdf5 hdf5_hl             ; modules to skip from "unreachable" warnings (see Compilers)
