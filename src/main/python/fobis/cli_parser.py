...
def _subparser_compiler(clean=False):
  """
  Construct a cli parser with the compiler group of arguments.
  ...
  parser_group.add_argument('-compiler', required=False, action='store', default='intel', type=str.lower, choices=('gnu', 'intel', 'g95', 'opencoarrays-gnu', 'custom'), help='Compiler used (value is case insensitive, default intel)')
...
def _subparser_directories():
  """
  Construct a cli parser with the directories group of arguments.
  ...
  parser_group.add_argument('-s', '--src', required=False, action='store', default='./', help='Root-directory of source files [default: ./]')
...
def _subparser_files(doctests=False):
  """
  Construct a cli parser with the files group of arguments.
...
def _subparser_fobos():
  """
  Construct a cli parser with the fobos group of arguments.
...
def _subparser_preform():
  """
  Construct a cli parser with the PreForM.py group of arguments.
...
def _subparser_fancy():
  """
  Construct a cli parser with the fancy group of arguments.
...
def _subparser_rules():
  """
  Construct a cli parser with the rules group of arguments.
...
def _subparser_rules_intrinsic():
  """
  Construct a cli parser with the rules_intrinsic group of arguments.
