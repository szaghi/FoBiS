...
def build():
  ...
  builder = Builder(compiler=__config__.cliargs.compiler,
                    ...
                    vlibs=__config__.cliargs.vlibs,
                    ext_libs=__config__.cliargs.ext_libs,
                    ext_vlibs=__config__.cliargs.ext_vlibs,
  ...
  __config__.check_vlibs_md5sum()
  __config__.check_ext_vlibs_md5sum()
  __config__.check_interdependent_fobos()
  dependency_hiearchy(builder=builder, pfiles=pfiles, colors=__config__.colors, force_compile=__config__.force_compile)
