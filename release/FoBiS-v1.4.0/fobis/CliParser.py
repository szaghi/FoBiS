...
def CliParser(appname, description, version):
    ...
    buildparser_g_files.add_argument('-vlibs', required=False, action='store', nargs='+', default=[], help='List of external libraries used that are not into the path and that are volatile (can changed thus triggering re-building): specify with full paths [default: None]')
