...
def CliParser(appname, description, version):
    ...
    buildparser_g_files.add_argument('-libs', required=False, action='store', nargs='+', default=[], help='List of external libraries use that are dnot into the path: specify with full paths [default: None]')
