...
def _rule_parser(clisubparsers):
  ...
  rulexparser_g_intrinsic.add_argument('-coverage', required=False, action='store', default=False, help='Intrinsic rule for performing coverage analysis', choices=('gnu', 'intel'))
  rulexparser_g_intrinsic.add_argument('-gcov_analyzer', required=False, action='store', default=None, help='Analyze .gcov coverage files saving a report for each file found', metavar='GCOV_REPORTS_DIR')
