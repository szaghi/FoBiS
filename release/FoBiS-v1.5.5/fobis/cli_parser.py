...
def _rule_parser(clisubparsers):
  ...
  rulexparser_g_intrinsic.add_argument('-coverage', required=False, action='store_true', default=False, help='Intrinsic rule for performing coverage analysis [default False]')
