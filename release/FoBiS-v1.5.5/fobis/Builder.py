...
class Builder(object):
  ...
  """
  s_compilers = {'gnu': ['gfortran', 'mpif90', '-J ', ['-ftest-coverage -fprofile-arcs', '-fprofile-arcs']],
                 'intel': ['ifort', 'mpif90', '-module ', ['', '']],
                 'g95': ['g95', 'mpif90', '-fmod=', ['', '']]}
  ...
  def __init__(self, cliargs, print_n=None, print_w=None):
    ...
    self._set_compiler(cliargs=cliargs)
  ...
  def _set_compiler(self, cliargs):
    """
    Method for setting compiler options.
    ...
    if cliargs.compiler.lower() in Builder.s_compilers:
      if cliargs.coverage:
        self.cflags += " " + Builder.s_compilers[cliargs.compiler.lower()][3][0]
        self.lflags += " " + Builder.s_compilers[cliargs.compiler.lower()][3][1]
      self.modsw = Builder.s_compilers[cliargs.compiler.lower()][2]
      if cliargs.mpi:
        self.fcs = Builder.s_compilers[cliargs.compiler.lower()][1]
      else:
        self.fcs = Builder.s_compilers[cliargs.compiler.lower()][0]
